...
function createNote() {
    ...
    var node0 = document.createElement("a" + "div");
    var node1 = document.createElement("h1");

    node1.innerHTML = notetext + "<br>" + "<small>click to check reply</small>";
    // node1.innerHTML = "<p>click to check reply</p>";
...
function color() {
    var random_color = ["#c2ff3d", "#ff3de8", "#3dc2ff", "limegreen", "#bc83e6", "#ebb328"];
